            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center relative z-10">
                ...
                >
                    ...
                    <p className="text-xl text-gray-600 leading-relaxed">
                        Join our vibrant community events featuring workshops,
                        hackathons, tech talks, and networking sessions. Learn
                        from experts, build projects, and grow with us.
                    </p>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        {eventTypes.map((event, index) => (
                            <div
                                key={event.title}
                                className="flex items-center space-x-3 p-4 bg-white/80 backdrop-blur-sm rounded-xl shadow-lg"
                            >
                                <div
