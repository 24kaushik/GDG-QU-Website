            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                        Your complete path to becoming a full-stack developer
                        with modern technologies and real-world projects
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                    ...
                    <div className="space-y-6">
                        <div className="bg-gradient-to-br from-white to-blue-50/30 rounded-3xl p-8 shadow-2xl border border-white/20">
                            ...
                            <div className="mb-6">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    {stages[currentStage].skills.map(
                                        (skill, index) => (
                                            <div
                                                key={index}
                            ...
                            <div className="mb-6">
                                ...
                                <div className="space-y-2">
                                    {stages[currentStage].projects.map(
                                        (project, index) => (
                                            <div
                                                key={index}
                            ...
                            <div>
                                ...
                                <div className="space-y-2">
                                    {stages[currentStage].resources.map(
                                        (resource, index) => (
                                            <a
                                                key={index}
                                                href={resource.link}
                        ...
                        <button className="w-full bg-gradient-to-r from-blue-500 to-green-500 hover:from-blue-600 hover:to-green-600 text-white py-4 rounded-xl font-bold text-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex items-center justify-center space-x-3">
                            <FaRocket />
                            <span>
                                Start {stages[currentStage].title.split(" ")[1]}{" "}
                                Stage
                            </span>
                        </button>
                    </div>
