...
const MobileDevRoadmap = () => {
  ...
  const stages = [
    {
      ...
      resources: [
        { name: "Flutter Docs", icon: "💙", link: "https://flutter.dev" },
        { name: "React Native", icon: "⚛️", link: "https://reactnative.dev" },
        {
      ...
      resources: [
        {
          ...
          icon: "🧩",
          link: "https://flutter.dev/widgets",
        },
        {
        ...
        { name: "Material Design", icon: "🎨", link: "https://material.io" },
      ],
      tips: [
        "Master navigation patterns",
        "Learn state management",
        "Practice smooth animations",
      ],
    },
    {
      id: 3,
      ...
      resources: [
        ...
        { name: "API Integration", icon: "🔌", link: "https://rapidapi.com" },
        {
          name: "Device APIs",
          icon: "📱",
  ...
  const ProgressRing = ({ stage, index, isActive }) => {
    ...
    const strokeDashoffset =
      circumference - (currentStage >= index ? circumference : 0);
    ...
    return (
      <div className="relative">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div
            className={`w-16 h-16 rounded-full flex items-center justify-center text-white text-2xl transition-all duration-300 ${
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-cyan-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Your complete path to becoming a full-stack developer with modern
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                    ...
                    <div className="flex items-center space-x-4">
                      <div className="relative">
                        <div
                          ...
                          style={{
                            backgroundColor:
                              currentStage >= index ? stage.color : "#d1d5db",
                          }}
                        ></div>
                        {index < stages.length - 1 && (
                          <div
                            className={`absolute top-3 left-1 w-0.5 h-8 transition-all duration-500 ${
                              currentStage > index ? "scale-y-100" : "scale-y-0"
                            }`}
                            style={{
                      ...
                      <div
                        className={`w-8 h-8 rounded-full flex items-center justify-center text-white font-bold text-sm transition-all duration-300 ${
                          currentStage === index ? "scale-110" : "scale-100"
                        }`}
                        style={{ backgroundColor: stage.color }}
                      >
                        {index + 1}
          ...
          <div className="space-y-6">
              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-2 gap-3">
                  {stages[currentStage].skills.map((skill, index) => (
                    <div
                      key={index}
                      className="flex items-center space-x-2 p-3 bg-white/50 rounded-lg border border-gray-200/50"
                    >
            ...
            <button className="w-full bg-gradient-to-r from-blue-500 to-green-500 hover:from-blue-600 hover:to-green-600 text-white py-4 rounded-xl font-bold text-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex items-center justify-center space-x-3">
              <FaRocket />
              <span>
                Start {stages[currentStage].title.split(" ")[1]} Stage
              </span>
            </button>
          </div>
        </div>
          ...
          {stages.map((_, index) => (
            <button
              ...
              style={{
                ...
                transform:
                  currentStage === index ? "rotate(360deg)" : "rotate(0deg)",
              }}
            >
              {index + 1}
            </button>
      ...
      <div className="fixed inset-0 pointer-events-none z-[-1]">
        ...
        ></div>
        <div
          className="absolute top-1/2 left-1/2 w-64 h-64 bg-purple-200/20 rounded-full blur-3xl animate-pulse"
