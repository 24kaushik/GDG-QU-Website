  ...
  return (
    <footer className="relative bg-gradient-to-br from-gray-900 via-slate-900 to-gray-950 text-white overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          className="absolute -bottom-40 -right-40 w-96 h-96 bg-green-500/10 rounded-full blur-3xl animate-pulse"
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center space-x-3 mb-6">
              <div className="relative">
                ...
                <div
                  className="absolute -bottom-1 -left-1 w-4 h-4 bg-red-500 rounded-full animate-ping"
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              Empowering developers through community, innovation, and Google's
              technologies. Join us in shaping the future of technology.
            </p>
              ...
              {techDomains.map((domain, index) => (
                ...
                >
                  <div
                    ...
                    style={{
                      backgroundColor: Object.values(colors)[index % 4],
                    }}
                  ></div>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between space-y-4 lg:space-y-0">
          ...
          <div className="flex items-center space-x-2 text-gray-400">
            ...
            <span className="text-sm">
              {currentYear} GDG Community. Made with{" "}
              <FaHeart className="inline text-red-400 mx-1" /> for developers
            </span>
          </div>
