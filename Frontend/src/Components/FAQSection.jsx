            ...
            <div className="max-w-6xl mx-auto relative z-10">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                        Everything you need to know about GDG community. Can't
                    ...
                    <div className="bg-gradient-to-r from-blue-500 to-green-500 rounded-3xl p-8 text-white relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-lg mb-6 opacity-90 max-w-2xl mx-auto">
                                Our community leads are here to help you get
                                started and answer any questions you might have.
                            </p>
