        ...
        const animate = () => {
            ...
            stars.forEach((star) => {
                ...
                const twinkleOpacity =
                    star.opacity + Math.sin(star.twinkle) * 0.3;
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center relative z-10">
                ...
                >
                    ...
                    <p className="text-xl text-gray-300 leading-relaxed">
                        Explore incredible projects built by our talented
                        student developers. From innovative web apps to
                        cutting-edge AI solutions - witness the future of
                        technology.
                    </p>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        {projectStats.map((stat, index) => (
                            <div
                                key={stat.label}
                                className="flex items-center space-x-3 p-4 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 hover:border-white/20 transition-all duration-300"
                            >
                                <div
