...
const GDGTeamWelcome = () => {
  ...
  // Canvas Animation - Networking Nodes
  useEffect(() => {
    setIsVisible(true);
  ...
  // Specific Tech Stack Icons for the orbit
  const orbitItems = [
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-white selection:bg-blue-100 selection:text-blue-700 font-sans">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <p className="text-lg text-gray-600 leading-relaxed max-w-xl">
              Meet the <strong>passionate individuals</strong> who work tirelessly to keep the GDG spirit alive. From organizing events to mentoring students, we are the architects building the bridge between campus and industry.
            </p>
          ...
          >
            ...
            <div className="relative bg-white/40 backdrop-blur-xl border border-white/60 rounded-[3rem] p-8 shadow-2xl h-[500px] flex flex-col justify-between overflow-hidden">
              ...
              <div className="absolute -top-12 z-30 scale-90 inset-0 flex items-center justify-center pointer-events-none">
                ...
                {/* 2. The Orbit Ring (Spinning Container) */}
                <div className="absolute w-[240px] h-[240px] rounded-full border border-dashed border-gray-300 animate-spin-slow flex items-center justify-center">
                  ...
                  {orbitItems.map((item, i) => (
                    <div
                      ...
                      style={{
                        // Mathematical positioning on the circle
                        transform: `rotate(${
                          i * 90
                        }deg) translate(140px) rotate(-${i * 90}deg)`,
                      }}
                    >
                      {/* Counter-Rotating Icon (Keeps it upright) */}
                      <div
              ...
              {/* FLOATING CODE SNIPPET (No Rotation, Just Float) */}
              <div
              ...
              >
                ...
                <div className="font-mono text-xs leading-5">
                  ...
                  <div className="flex gap-2 mt-1">
                    <span className="text-yellow-300">15 Active Contributors</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="mt-20 pt-10 border-t border-gray-100">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              >
                <div
                  className={`absolute left-0 top-0 bottom-0 w-1 bg-${item.color}-500 opacity-0 group-hover:opacity-100 transition-opacity`}
                ></div>
                <FaLightbulb
                  className={`text-gray-200 text-2xl absolute top-6 right-6 group-hover:text-${item.color}-500 transition-colors`}
                />
      ...
      <style jsx>{`
        /* Gentle vertical float for the code snippet (No Rotation) */
        ...
        /* Container Spin: Rotates the ring */
        @keyframes spin-slow {
          from {
        ...
        /* Reverse Spin: Keeps icons upright inside the spinning ring */
