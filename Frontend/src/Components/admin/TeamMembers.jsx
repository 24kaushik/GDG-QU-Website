const TeamMembers = () => {
    ...
    const members = [
        { id: 1, name: "Aisha Khan", avatar: "https://i.pravatar.cc/64?u=aisha.khan" },
        { id: 2, name: "Omar Farooq", avatar: "https://i.pravatar.cc/64?u=omar.farooq" },
        { id: 3, name: "Lina Patel", avatar: "https://i.pravatar.cc/64?u=lina.patel" },
        { id: 4, name: "Samir Ali", avatar: "https://i.pravatar.cc/64?u=samir.ali" },
    ];
        ...
        <div className="w-full lg:w-1/3 mt-6 lg:mt-0 lg:p-4">
            <div className="backdrop-blur-lg bg-white/30 p-6 rounded-2xl border border-white/20 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 w-full">
                <div className="flex items-center justify-between mb-4">
                    <div>
                        <h3 className="text-2xl font-bold text-gray-900">Total team members</h3>
                ...
                <div className="mt-2">
                    <h4 className="text-sm text-gray-600 mb-3">Core team members</h4>
