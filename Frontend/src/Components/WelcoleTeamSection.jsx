    ...
    useEffect(() => {
        ...
        const animate = () => {
            ...
            nodes.forEach((node, index) => {
                ...
                // Pulsing effect
                const pulseSize =
                    node.size + Math.sin(node.pulse) * (isMobile ? 1 : 2);
                        ...
                        >
                            ...
                            <div className="space-y-4">
                                ...
                                <p className="text-base lg:text-lg text-gray-600 leading-relaxed">
                                    A passionate group of developers, designers,
                                    and innovators working together to create
                                    amazing experiences with Google
                                    technologies.
                                </p>
                            </div>
